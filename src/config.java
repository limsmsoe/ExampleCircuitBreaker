public class config {
    ...
    public static final int DEFAULT_TABLES = 25; // How many tables are in the dining room
    ...
    public static long circuitBreakerOpenTime = DEFAULT_CIRCUIT_BREAKER_OPEN_TIME;
    public static long millisecondsPerStep = DEFAULT_MILLISECONDS_PER_STEP;
}
